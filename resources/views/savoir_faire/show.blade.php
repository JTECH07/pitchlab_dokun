    ...
    <main class="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <div class="bg-white rounded-2xl p-7 shadow-sm border border-gray-100 text-center">
                ...
                <div class="text-[#17201D]/60 text-sm font-semibold mt-1">Artisan(s) praticien(s)</div>
            </div>
            <div class="bg-white rounded-2xl p-7 shadow-sm border border-gray-100 text-center">
                ...
                <div class="text-[#17201D]/60 text-sm font-semibold mt-1">Zone d'expérimentation</div>
            </div>
            <div class="bg-white rounded-2xl p-7 shadow-sm border border-gray-100 text-center">
                ...
                <div class="serif text-2xl text-[#064E3B]">Expériences</div>
                <div class="text-[#17201D]/60 text-sm font-semibold mt-1">Disponibles à la réservation</div>
            </div>
        </div>
        ...
        <div class="mb-16">
            <h2 class="serif text-3xl md:text-4xl text-[#064E3B] mb-2">
                Artisans pratiquant <span class="text-[#C99424]">{{ $savoirFaire->name }}</span>
            </h2>
            ...
            <div class="bg-white rounded-3xl p-14 text-center border border-gray-100">
                ...
                <p class="text-[#17201D]/60 text-lg">Aucun artisan rattaché pour l'instant.</p>
                <a href="{{ route('artisans.index') }}" class="mt-6 inline-block px-6 py-3 bg-[#064E3B] text-white font-bold rounded-xl">Voir tous les artisans</a>
            </div>
            @else
                ...
                <a href="{{ route('artisans.show', $artisan->id) }}" class="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 group hover:-translate-y-1 transition-all duration-300 block">
                    ...
                    <div class="p-7">
                        ...
                        <div class="flex gap-3">
                            <span class="flex-1 text-center py-3 bg-[#064E3B] text-white rounded-xl font-semibold text-sm">Voir le profil</span>
                            @if($artisan->whatsapp)
