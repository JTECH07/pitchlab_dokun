        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="sm:col-span-3">
                    ...
                    <input type="text" name="address" value="{{ old('address') }}" placeholder="Quartier, Porto-Novo" class="w-full px-4 py-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-amber-500 outline-none bg-slate-50">
                </div>
                <div class="sm:col-span-1">
                    <label class="block text-sm font-bold text-slate-700 mb-1.5">Latitude</label>
                    <input type="number" step="any" name="latitude" value="{{ old('latitude', '6.4969') }}" class="w-full px-4 py-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-amber-500 outline-none bg-slate-50">
                </div>
                <div class="sm:col-span-1">
                    <label class="block text-sm font-bold text-slate-700 mb-1.5">Longitude</label>
                    <input type="number" step="any" name="longitude" value="{{ old('longitude', '2.6289') }}" class="w-full px-4 py-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-amber-500 outline-none bg-slate-50">
                </div>
                <div class="sm:col-span-1">
