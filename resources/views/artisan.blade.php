...
<main class="pt-32 pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
 ...
 <h3 class="font-bold text-sm text-dokun-charcoal mb-1"><x-icon name="volume" class="inline-block w-4 h-4 mr-1 text-dokun-charcoal align-text-bottom" /> ƉƆKUN Voice</h3>
 ...
 <h3 class="font-bold text-sm text-dokun-charcoal mb-1"><x-icon name="book-open" class="inline-block w-4 h-4 mr-1 text-amber-600 align-text-bottom" /> ƉƆKUN Learn</h3>
 ...
 <h3 class="font-bold text-sm text-dokun-charcoal mb-1"> Carte</h3>
 ...
 <h3 class="font-serif text-2xl text-white mb-2"><x-icon name="volume" class="inline-block w-6 h-6 mr-1 text-white align-text-bottom" /> ƉƆKUN Voice</h3>
 ...
 <h3 class="font-serif text-2xl text-amber-900 mb-2"><x-icon name="book-open" class="inline-block w-6 h-6 mr-1 text-amber-900 align-text-bottom" /> ƉƆKUN Learn</h3>
