    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-10 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div class="md:col-span-2">
            <div class="flex items-center gap-3 mb-5">
                <div class="w-12 h-12 bg-dokun-green rounded-xl flex items-center justify-center shrink-0 overflow-hidden"><img src="{{ url('images/dokun_logo.png') }}" alt="Logo ƉƆKUN" class="w-full h-full object-contain"></div>
                <div class="flex flex-col leading-tight">
                    <span class="font-serif text-3xl">ƉƆKUN</span>
                    <span class="text-[8.5px] tracking-[0.16em] opacity-70 uppercase font-semibold whitespace-nowrap">{{ __('app.brand_tagline') }}</span>
                </div>
            </div>
