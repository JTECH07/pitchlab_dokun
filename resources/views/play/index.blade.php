...
<main class="pt-24 pb-24">
 ...
 <div class="text-6xl mb-4"><x-icon name="sparkles" class="w-16 h-16 mx-auto text-dokun-gold" /></div>
 ...
 <span class="text-2xl"><x-icon name="check-circle" class="w-6 h-6 text-dokun-gold opacity-50" /></span>
