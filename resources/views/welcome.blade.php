...
<!-- STATS BAR -->
<section class="bg-[#064E3B] text-white py-10" id="stats-section">
 <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 text-center">
 <div><div class="serif text-4xl text-[#C99424]"><span class="stat-counter" data-target="{{ $artisansCount }}">0</span>+</div><div class="text-white/70 text-sm mt-1 font-semibold uppercase tracking-wider">{{ __('app.welcome_stat_artisans') }}</div></div>
...
<!-- REJOINDRE L'ÉCOSYSTÈME (CDC §3 — Les acteurs de la plateforme) -->
<section class="py-28 bg-[#F8F6F0] relative overflow-hidden">
 <div class="absolute inset-0 wax-pattern opacity-20"></div>
 <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
 <div class="text-center mb-16 fade-up">
 <span class="inline-flex items-center gap-2 mb-4 px-5 py-2 rounded-full border border-[#C99424]/50 bg-[#C99424]/10 text-[#C99424] text-xs font-bold uppercase tracking-[0.2em]">
 <x-icon name="users" class="w-4 h-4" /> Rejoindre l'écosystème
 </span>
 <h2 class="serif text-4xl md:text-5xl text-[#064E3B] mb-4">Vous êtes…</h2>
 <p class="text-[#17201D]/60 max-w-2xl mx-auto text-lg">ƉƆKUN est un écosystème vivant. Chaque acteur a un rôle unique dans la chaîne de valeur du patrimoine culturel béninois.</p>
 <div class="h-1 w-20 bg-[#C99424] mx-auto mt-5"></div>
 </div>
 <div class="grid grid-cols-1 md:grid-cols-3 gap-8">

 {{-- VISITEUR / TOURISTE --}}
 <div class="bg-white rounded-[2rem] p-8 shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all group">
 <div class="w-14 h-14 rounded-2xl bg-[#064E3B] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
 <x-icon name="compass" class="w-7 h-7 text-[#C99424]" />
 </div>
 <span class="text-xs font-bold uppercase tracking-[0.2em] text-[#C99424] mb-2 block">Visiteur & Touriste</span>
 <h3 class="serif text-2xl text-[#064E3B] mb-4">Explorez, apprenez, vivez</h3>
 <ul class="space-y-2 text-[#17201D]/70 text-sm mb-8">
 <li class="flex items-start gap-2"><x-icon name="check-circle" class="w-4 h-4 text-[#064E3B] mt-0.5 shrink-0" /> Découvrez les artisans sur la carte interactive</li>
 <li class="flex items-start gap-2"><x-icon name="check-circle" class="w-4 h-4 text-[#064E3B] mt-0.5 shrink-0" /> Réservez des expériences culturelles uniques</li>
 <li class="flex items-start gap-2"><x-icon name="check-circle" class="w-4 h-4 text-[#064E3B] mt-0.5 shrink-0" /> Apprenez le Fon/Gun avec ƉƆKUN Learn</li>
 <li class="flex items-start gap-2"><x-icon name="check-circle" class="w-4 h-4 text-[#064E3B] mt-0.5 shrink-0" /> Gagnez des badges sur votre Passeport Culturel</li>
 </ul>
 <a href="{{ route('artisans.index') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-[#064E3B] text-white font-bold rounded-xl hover:bg-[#064E3B]/90 transition text-sm">
 Explorer les artisans <x-icon name="bolt" class="w-4 h-4" />
 </a>
 </div>

 {{-- ARTISAN / ACTEUR CULTUREL --}}
 <div class="bg-[#064E3B] rounded-[2rem] p-8 shadow-2xl border border-[#C99424]/30 hover:shadow-xl hover:-translate-y-1 transition-all group relative overflow-hidden">
 <div class="absolute top-0 right-0 w-40 h-40 bg-[#C99424]/10 rounded-bl-full pointer-events-none"></div>
 <div class="w-14 h-14 rounded-2xl bg-[#C99424] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform relative z-10">
 <x-icon name="flame" class="w-7 h-7 text-white" />
 </div>
 <span class="text-xs font-bold uppercase tracking-[0.2em] text-[#C99424] mb-2 block relative z-10">Artisan & Acteur Culturel</span>
 <h3 class="serif text-2xl text-white mb-4 relative z-10">Valorisez votre savoir-faire</h3>
 <ul class="space-y-2 text-white/70 text-sm mb-8 relative z-10">
 <li class="flex items-start gap-2"><x-icon name="check-circle" class="w-4 h-4 text-[#C99424] mt-0.5 shrink-0" /> Créez votre profil et fiche savoir-faire</li>
 <li class="flex items-start gap-2"><x-icon name="check-circle" class="w-4 h-4 text-[#C99424] mt-0.5 shrink-0" /> Recevez des réservations et gérez vos expériences</li>
 <li class="flex items-start gap-2"><x-icon name="check-circle" class="w-4 h-4 text-[#C99424] mt-0.5 shrink-0" /> Préservez votre histoire avec ƉƆKUN Voice</li>
 <li class="flex items-start gap-2"><x-icon name="check-circle" class="w-4 h-4 text-[#C99424] mt-0.5 shrink-0" /> Commission de 10% sur ventes & expériences</li>
 </ul>
 <a href="{{ route('actor-requests.form') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-[#C99424] text-white font-bold rounded-xl hover:bg-yellow-500 transition text-sm relative z-10">
 {{ __('app.nav_join') }} <x-icon name="bolt" class="w-4 h-4" />
 </a>
 </div>

 {{-- PARTENAIRE HÔTEL / GUIDE / AGENCE --}}
 <div class="bg-white rounded-[2rem] p-8 shadow-lg border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all group">
 <div class="w-14 h-14 rounded-2xl bg-[#17201D] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
 <x-icon name="gem" class="w-7 h-7 text-[#C99424]" />
 </div>
 <span class="text-xs font-bold uppercase tracking-[0.2em] text-[#C99424] mb-2 block">Hôtel, Guide & Agence</span>
 <h3 class="serif text-2xl text-[#064E3B] mb-4">Enrichissez votre offre</h3>
 <ul class="space-y-2 text-[#17201D]/70 text-sm mb-8">
 <li class="flex items-start gap-2"><x-icon name="check-circle" class="w-4 h-4 text-[#064E3B] mt-0.5 shrink-0" /> Intégrez des expériences culturelles à votre catalogue</li>
 <li class="flex items-start gap-2"><x-icon name="check-circle" class="w-4 h-4 text-[#064E3B] mt-0.5 shrink-0" /> Orientez vos clients vers les artisans locaux</li>
 <li class="flex items-start gap-2"><x-icon name="check-circle" class="w-4 h-4 text-[#064E3B] mt-0.5 shrink-0" /> Tableau de bord partenaire & suivi des commissions (V2)</li>
 <li class="flex items-start gap-2"><x-icon name="check-circle" class="w-4 h-4 text-[#064E3B] mt-0.5 shrink-0" /> Commission de 5% sur les orientations marketplace</li>
 </ul>
 <a href="{{ route('contact') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-[#17201D] text-white font-bold rounded-xl hover:bg-[#17201D]/80 transition text-sm">
 Nous contacter <x-icon name="message" class="w-4 h-4" />
 </a>
 </div>
